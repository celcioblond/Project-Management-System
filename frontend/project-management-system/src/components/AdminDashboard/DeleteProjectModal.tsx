// src/components/AdminDashboard/DeleteProjectModal.tsx
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="px-6 py-6 space-y-4">
          <p className="text-sm text-slate-600 leading-relaxed">
            ...
            and comments will also be removed. This action{' '}
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 space-y-1.5">
            ...
            <div className="flex items-center gap-3 pt-0.5">
              <span className="text-xs text-slate-400">
                {project.assignedEmployeeNames?.length ?? 0} member
                {(project.assignedEmployeeNames?.length ?? 0) !== 1 ? 's' : ''}
              </span>
